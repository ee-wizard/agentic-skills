...
exports.createMBEPPT = createMBEPPT;
...
function createMBEPPT(outputPath) {
    ...
    const planItems = [
        {
            title: "课程选择",
            desc: "了解必修与选修，合理规划每学期",
            color: MBE.yellow,
        },
        { title: "时间管理", desc: "平衡学习、社团与休闲时间", color: MBE.purple },
        {
            title: "考证规划",
            desc: "英语四六级、计算机等级、专业证书",
            color: MBE.red,
        },
        {
            title: "发展方向",
            desc: "考研、留学、就业，提前规划路径",
            color: MBE.blue,
        },
    ];
    ...
    const output = outputPath ||
        path.join(os.homedir(), "Desktop", "大学新生开学第一课_MBE风格.pptx");
...
//# sourceMappingURL=generate_mbe.js.map